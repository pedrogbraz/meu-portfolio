...
export default function Points() {
  return (
    <section className="py-24">
      <div className="px-8 sm:px-12 lg:px-16 py8">
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:justify-between">
          <div className="mx-auto max-w-lg text-center lg:text-start lg:mx-0">
            ...
            <a
              href="/projetos"
              className="mt-6 inline-block rounded-full text-[--color-theme] text-sm font-medium] transition focus:outline-none"
            >
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-yellow-400 focus:outline-none focus:ring duration-200">
            ...
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-blue-700 focus:outline-none focus:ring duration-200">
            ...
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-green-500 focus:outline-none focus:ring duration-200">
            ...
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-pink-500 focus:outline-none focus:ring duration-200">
            ...
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-slate-800 focus:outline-none focus:ring duration-200">
            ...
            <div className="block rounded-xl hover:scale-[1.02] shadow-sm hover:shadow-md border border-[#999]/20 p-4 hover:border-red-700 focus:outline-none focus:ring duration-200">
              <span className="inline-block rounded-xl shadow-lg bg-red-300/80 p-2">
                <IoInvertMode className="text-red-700 size-8" />
              </span>

              <h2 className="mt-2 font-semibold">Escalável</h2>
